        ...
        <div class="container">
          ...
          <div>
            <div class="reg" style="padding-top: 35px;">
              <pre> 
               <center>   <img src="images/vote.jpg" height="90x" width="90x"/> <%=a[4]%>  <img src="images/vote.jpg" height="90x" width="90x"/> <%=a[1]%>  <img src="images/vote.jpg" height="90x" width="90x"/> <%=a[3]%>    <img src="images/vote.jpg" height="90x" width="90x"/> <%=a[0]%>   <img src="images/vote.jpg" height="90x" width="90x"/> <%=a[2]%> </center>                                                                                        
              </pre>
            </div>
            <hr>
          </div>
